 ...
 *
 * <p>NOTE: Enabling infostreams may cause performance degradation in some components.
 *
 * @lucene.internal
 */
public abstract class InfoStream implements Closeable {
  ...
  /**
   * Sets the default {@code InfoStream} used by a newly instantiated classes. It cannot be {@code
   * null}, to disable logging use {@link #NO_OUTPUT}.
   *
   * @see #getDefault
   */
